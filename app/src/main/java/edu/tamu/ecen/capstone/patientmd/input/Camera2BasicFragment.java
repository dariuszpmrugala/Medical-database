...
public class Camera2BasicFragment extends Fragment
     ...
     *
     * Choose camera which has the desired characteristics,
     *  and set up other data based on chosen camera
     *
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                // We need the camera facing away from the user for capturing image
    ...
    private void createCameraPreviewSession() {
        try {
            ...
            Log.d(TAG, "Build Capture Request");
                    ...
                    new CameraCaptureSession.StateCallback() {
                        ...
                        public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                            ...
                            try {
                                ...
                                // todo once camera works, set AF mode for continuous
            ...
            case R.id.info: {
                ...
                if (null != activity) {
                    new AlertDialog.Builder(activity)
                            .setMessage(R.string.camera_message)
